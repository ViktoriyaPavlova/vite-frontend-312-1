...
const renderData = (filterValue, searchValue) => {
    ...
    <a
        class=tasks-details.html?id=${product.id}"card-link"
        href=""
        target="_blank"
    ...
    <div class="card">
        ...
        <div class="card-text">
            ...
            <div
                class="card-text__descr text-secondary skeleton"
            >
                Расстояние: 10 885 километров
            </div>
            <div class="card-text__date text-secondary skeleton">
                16-21 октября
            </div>
            <div
                class="card-text__price flex text-secondary skeleton"
            >
            ...
            <div class="card-bottom">
                <button data-variant="primary" class="skeleton">
                    Add to card
                </button>
            </div>
        </div>
